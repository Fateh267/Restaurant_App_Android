...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // creates a thread to wait for incoming connection
    ...
    // gets the input stream from an established connection
    ...
    // scans the active connection for incoming order
    ...
    // cleans up variables when connection is dropped
    public void cleanup(){
        insecureAT = null;
        ipstream = null;
        try {
